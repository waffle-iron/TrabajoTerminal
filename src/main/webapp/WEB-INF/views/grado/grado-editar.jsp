                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Editar grado
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <c:url value="/grado/guardarCambios" var="urlGradoGuardar" />
                            <form:form action="${urlGradoGuardar}" method="post" commandName="grado" >
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Nombre *: </label>
                                        <div class="col-md-4">
                                            <div class="input-icon right">
                                                <form:hidden path="idGrado" />
