				...
				<div class="row">
					<div class="col-md-12">
						...
						<c:forEach items="${escuelas}" var="escuela">
							<li>ID: ${escuela.idEscuela} ## NOMBRE: ${escuela.nombre} <a href="${contexto}/escuela/${escuela.idEscuela}/editar">EDITAR</a> ******* <a href="${contexto}/escuela/eliminar/${escuela.idEscuela}">ELIMINAR</a></li>
						</c:forEach>
						</ul>
					</div>
				</div>
