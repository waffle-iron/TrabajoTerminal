                ...
                <div class="col-md-12">
                    <div class="portlet light">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-shopping-cart"></i>Escuelas
                            </div>
                            ...
                            <div class="table-scrollable">
                                <table class="table table-striped table-bordered table-advance table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th>
                                            <i class="fa fa-bookmark"></i> abreviación
                                        </th>
                                        <th>
                                            <i class="fa fa-bookmark"></i> Área
                                        </th>
                                        <th>
                                            <i class="fa fa-bookmark"></i> Nivel
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>

                                    <c:forEach items="${escuelasList}" var="escuela">
                                        <tr>
                                            <td>
                                                <a href="${contexto}escuela/ver/${escuela.id}">
                                                    ${escuela.id}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="${contexto}area/ver/${escuela.area.idArea}">
                                                    ${escuela.area.nombre}
                                                </a>
                                            </td>
                                            <td>
                                                <a href="${contexto}nivel/ver/${escuela.nivel.idNivel}">
