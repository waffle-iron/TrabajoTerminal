...
<head>
    <meta charset="utf-8"/>
    <title>Sistema de b�squeda de informaci�n de proyectos enfocada a los trabajos de investigaci�n en el IPN</title>
...
<div class="content">
    ...
    <form class="login-form" action="${rutaAutentificar}" method="POST">
        <h3 class="form-title">Inicio de sesi�n</h3>
        ...
        <div class="form-actions">
            <button type="submit" class="btn blue pull-right">
                Iniciar Sesi�n <i class="m-icon-swapright m-icon-white"></i>
            </button>
        </div>
        <div class="create-account">
            <p>
                A�n no tienes una cuenta?&nbsp; <a href="${contexto}registro" id="register-btn">
                Registrate</a>
            </p>
        </div>
    </form>
