                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Editar Nivel
                            </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <c:url value="/nivel/guardarCambios" var="urlNivelGuardar" />
                            <form:form action="${urlNivelGuardar}" method="post" commandName="nivel" >
                                <div class="form-body">
                                    <div class="form-group">
                                        <label class="control-label col-md-3">Nombre *: </label>
                                        <div class="col-md-4">
                                            <div class="input-icon right">
                                                <form:hidden path="idNivel" />
