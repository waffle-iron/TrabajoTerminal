				...
				<div class="row">
					<div class="col-md-12">
						...
						<c:forEach items="${niveles}" var="nivel">
							<li>ID: ${nivel.idNivel} ## NOMBRE: ${nivel.nombre} <a href="${contexto}/nivel/${nivel.idNivel}/editar">EDITAR</a> ******* <a href="${contexto}/nivel/eliminar/${nivel.idNivel}">ELIMINAR</a></li>
						</c:forEach>
						</ul>
					</div>
				</div>
