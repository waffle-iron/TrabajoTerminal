				...
				<div class="row">
					<div class="col-md-12">
						...
						<c:forEach items="${grados}" var="grado">
							<li>ID: ${grado.idGrado} ## NOMBRE: ${grado.nombre} <a href="${contexto}/grado/${grado.idGrado}/editar">EDITAR</a> ******* <a href="${contexto}/grado/eliminar/${grado.idGrado}">ELIMINAR</a></li>
						</c:forEach>
						</ul>
					</div>
				</div>
