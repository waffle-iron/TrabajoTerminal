				...
				<div class="row">
					<div class="col-md-12">
						...
						<c:forEach items="${estados}" var="estado">
							<li>ID: ${estado.idEstado} ## NOMBRE: ${estado.nombre} <a href="${contexto}/estado/${estado.idEstado}/editar">EDITAR</a> ******* <a href="${contexto}/estado/eliminar/${estado.idEstado}">ELIMINAR</a></li>
						</c:forEach>
						</ul>
					</div>
				</div>
