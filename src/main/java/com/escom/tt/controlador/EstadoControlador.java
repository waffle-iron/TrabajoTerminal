...
public class EstadoControlador {
	...
	public String crear(Model modelo) {
		modelo.addAttribute("idioma", new Estado());
		return "estado-crear";
	}
	...
	public String editar(@PathVariable Integer estadoId,Model modelo) {
		...
		if (estado != null) {
			modelo.addAttribute("idioma", estado);
			ruta = "estado-editar";
		}
		else
	...
	@RequestMapping(value="/estado/ver/{idiomaId:[0-9]+}")
	...
	@RequestMapping(value="/estado/eliminar/{idiomaId:[0-9]+}")
