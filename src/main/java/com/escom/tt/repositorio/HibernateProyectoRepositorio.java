...
public class HibernateProyectoRepositorio implements ProyectoRepositorio {
	...
	public List<Proyecto> obtenerTodos() {
		...
		proyectos = sf.getCurrentSession().createCriteria(Proyecto.class)
				.list();
		return proyectos;
	}

	@Override
	public ColaboradorProyecto addColaborador(
	...
	@Override
	public ColaboradorProyecto getColaborador(
			ColaboradorProyecto colaboradorProyecto) {
		ColaboradorProyecto cp = null;
		Session sesion = sf.getCurrentSession();
		cp = (ColaboradorProyecto) sesion.get(ColaboradorProyecto.class,
				colaboradorProyecto.getId());
		return cp;
	}
	...
	// En en la restricción siempre debe estar un obejto cuando hay una
	// relación, este ejemplo: PROYECTO-USUARIO
